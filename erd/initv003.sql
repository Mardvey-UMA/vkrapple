...
CREATE TABLE public.category (
	...
	CONSTRAINT "категория_pk" PRIMARY KEY (category_id)
);
-- ddl-end --
...
CREATE TABLE public.attribute (
	...
	CONSTRAINT "атрибут_pk" PRIMARY KEY (attribute_id)
);
-- ddl-end --
...
CREATE TABLE public.value (
	...
	CONSTRAINT "значение_pk" PRIMARY KEY (value_id)
);
-- ddl-end --
...
CREATE TABLE public.product (
	...
	category_id_category bigint NOT NULL,
	CONSTRAINT "товар_pk" PRIMARY KEY (product_id)
);
-- ddl-end --
...
CREATE TABLE public."order" (
	...
	CONSTRAINT "заказы_pk" PRIMARY KEY (order_id)
);
-- ddl-end --
...
CREATE TABLE public."заказы_товары" (
	...
	product_id_product bigint NOT NULL,
	CONSTRAINT "заказы_товары_pk" PRIMARY KEY (order_product_id)
);
-- ddl-end --
...
CREATE TABLE public._user (
	...
	address varchar(255),
	created_at date,
	CONSTRAINT "пользователь_pk" PRIMARY KEY (_user_id)
);
-- ddl-end --
...
CREATE TABLE public.cart (
	...
	_user_id__user bigint NOT NULL,
	CONSTRAINT "корзина_pk" PRIMARY KEY (cart_id)
);
-- ddl-end --
...
-- object: product_fk | type: CONSTRAINT --
-- ALTER TABLE public."заказы_товары" DROP CONSTRAINT IF EXISTS product_fk CASCADE;
ALTER TABLE public."заказы_товары" ADD CONSTRAINT product_fk FOREIGN KEY (product_id_product)
REFERENCES public.product (product_id) MATCH FULL
ON DELETE RESTRICT ON UPDATE CASCADE;
-- ddl-end --

-- object: order_fk | type: CONSTRAINT --
-- ALTER TABLE public."заказы_товары" DROP CONSTRAINT IF EXISTS order_fk CASCADE;
ALTER TABLE public."заказы_товары" ADD CONSTRAINT order_fk FOREIGN KEY (order_id_order)
...
CREATE TABLE public.photo (
	...
	created_at date,
	CONSTRAINT "фото_pk" PRIMARY KEY (photo_id)
);
-- ddl-end --
...
CREATE TABLE public.photo_product (
	...
	product_id_product bigint NOT NULL,
	CONSTRAINT "фото_товары_pk" PRIMARY KEY (photo_product_id)
);
-- ddl-end --
...
CREATE TABLE public.review (
	...
	product_id_product bigint,
	CONSTRAINT "отзыв_pk" PRIMARY KEY (review_id)
);
-- ddl-end --
...
CREATE TABLE public.wish_list (
	...
	product_id_product bigint,
	_user_id__user bigint NOT NULL,
	CONSTRAINT "желания_pk" PRIMARY KEY (wish_list_id)
);
-- ddl-end --
...
CREATE TABLE public.review_photo (
	...
	CONSTRAINT "отзыв_фото_pk" PRIMARY KEY (review_photo_id)
);
-- ddl-end --
